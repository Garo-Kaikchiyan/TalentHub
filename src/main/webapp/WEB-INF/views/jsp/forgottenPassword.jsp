...
<div class="header">
	<div id="logo" class="header"><a href="/TalentHub/index"><img src="img/logo.png"/></a> </div>
		...
		<input placeholder="Password" type="password" name="password"/><br> <a href="/TalentHub/forgottenPassword">
